...
import control.departmentShowAction;
import control.locSapXepNhanVien;
import control.locTaiKhoan;
import control.locXapSepDanhGia;
import control.luuChinhSuaQuyen;
import control.luuThemNhomQuyen;
import control.luuThemSuaPhongBan;
import control.phuCapNhanVien;
import control.sapXepHopDong;
import control.sapXepNhanVienKiHopDong;
import control.showDanhGia;
import control.showDanhGiaForm1;
import control.showDanhGiaForm2;
import control.showGiaHanHopDong;
import control.showNhanVienCuaPhongBan;
import control.showNhanVienKiHopDong;
import control.showNhapFileNhanVien;
import control.showThongTinNhanVienPhongBan;
import control.showThongTinNhomQuyen;
import control.showThongTinTaiKhoan;
import control.suKienFormHopDong1;
import control.suKienGiaHanHopDong;
import control.suaNhanVien;
import control.BCCDenFormThem;
import control.BCCDieuKhienF3;
import control.BCCLoc;
import control.BCCQuayLai;
import control.BCCRightClick;
import control.BCCSapXep;
import control.BCCSave;
import control.BCCSua;
import control.BCCThem;
import control.BCCTimKiem;
import control.BCCXoa;
import control.BCC_ChiTietChamCong_Mouse;
import control.DanhGiaRightClick;
import control.DanhGia_Action;

import control.TimKiemUngVien_Key;
import control.TimKimBCTD_Key;
import control.TimKimDG_Key;
import control.TuyenDungAction;
import control.TuyenDungMouse;
import control.UngVienAction;
import control.UngVienItem;
import control.UngVienMouse;
import control.UngVienView_TuyenUngVien_Action;
import control.UngVienView_Tuyen_HienThi_Action;
import control.UngVien_Table_Action;
import control.cbbPhuongXaNhanVien;
import control.cbbPhuongXaUngVien;
import control.cbbQuanHuyenNhanVien;
import control.cbbQuanHuyenUngVien;
import control.cbbTinhThanhPhoNhanVien;
import control.cbbTinhThanhPhoUngVien;
import control.chinhSuaNhomQuyen;
import control.showThemNhanVien;
import control.showSuaNhanVien;
import control.themNhanVien;
import control.themNhanVienImportExcel;
import control.thongKeHopDong;
import control.timKiemHopDong;
import control.timKiemLuong;
import control.huySuaNhanVien;
import control.huyTuyenUngVien;
import control.khoanTruNhanVien;
import control.locDanhGiaNgayThang;
import control.locHopDong;
import control.locLuong;
import control.locLuongThuong;
import control.locPhuCapKhoanTru;
import control.xoaNhanVien;
import control.xoaNhanVienImportExcel;
import control.xoaNhomQuyen;
import control.xoaPhongBan;
import control.xuatFileBangChamCong;
import control.xuatFileHopDong;
import control.xuatFileLuong;
import control.xuatFileNhanVien;
import control.xuatFilePhongBan;
import control.suaPhongBan;
import control.sukienBangNhanVienRightClick;
import control.taoHopDong;
import control.themLuongThuong;
import control.timKiemNhanVien;
import control.troVeTrangHopDong;
import control.xemChiTietNhanVien;
import control.diChuyenChuongTrinh;
import control.diChuyenOptionPanel;
import control.dieuChinhMucLuong;
import control.dieuChinhMucLuongTuDong;
import control.dieuChinhNhanSuPhongBan;
import control.huyHopDong;
import control.troVeTrangNhanVien1;
import control.xemChiTietDanhGia;
import control.xemChiTietNhanVienImportExcel;
import control.xoaDanhGia;
